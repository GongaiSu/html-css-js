...
import { getDateFormatMonthDay } from '@/utils/getDateFormat';
import { computed } from '@vue/reactivity';
import { storeToRefs } from 'pinia';

const mainStore = useMainStore()
const { startDate, endDate } = storeToRefs(mainStore)
const startDateStr = computed(() => getDateFormatMonthDay(startDate.value, "MM.DD"))
const endDateStr = computed(() => getDateFormatMonthDay(endDate.value, "MM.DD"))
